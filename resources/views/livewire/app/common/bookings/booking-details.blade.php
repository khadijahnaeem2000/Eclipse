<div x-data="{ rescheduleBooking: false, addDocuments: false, assignProvider: false }">
                        ...
                        <div class="row between-section-segment-spacing">
                            ...
                            <div class="col-lg-6">
                                ...
                                <div class="mb-4">
                                    ...
                                    <textarea class="form-control" rows="4" cols="4" id="payment-notes"  wire:model.defer="booking.billing_notes"></textarea>
                                </div><!-- /Payment Notes -->
                                       <div class="col-lg-12">
  ...
  <!-- commented out this as it conflicting with Notes update  -->
